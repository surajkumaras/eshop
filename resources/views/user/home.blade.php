        ...
        <div id="carouselExampleIndicators" class="carousel slide carousel-fade" data-bs-ride="carousel" data-bs-interval="false">
            <div class="carousel-inner">
                <div class="carousel-item active">
                    ...
                    <picture>
                        <source media="(max-width: 799px)" srcset="{{ asset('user-assets/images/carousel-1.jpg')}}" />
                ...
                <div class="carousel-item">
                    ...
                    <picture>
                        <source media="(max-width: 799px)" srcset="{{ asset('user-assets/images/carousel-2.jpg')}}" />
                ...
                <div class="carousel-item">
                    ...
                    <picture>
                        <source media="(max-width: 799px)" srcset="{{ asset('user-assets/images/carousel-3.jpg')}}" />
                ...
                @if (getCategory()->isNotEmpty())
                    @foreach (getCategory() as $cat)
                        <div class="col-lg-3">
                            <div class="cat-card">
                                <div class="left">
                                    <img src="{{ asset('/img/category/'.$cat->image)}}" alt="" class="img-fluid">
                                </div>
                                <div class="right">
                                    <div class="cat-data">
                                        <h2>{{$cat->name}}</h2>
                    ...
                    @foreach ($products as $prodImage )
                        <div class="col-md-3">
                            <div class="card product-card">
                                ...
                                <div class="card-body text-center mt-3">
                                    <a class="h6 link" href="{{ route('product',['id'=>$prodImage->id])}}">{{$prodImage->name}}</a>
                                    <div class="price mt-2">
                                        <span class="h5"><strong><i class='fas fa-rupee-sign' style='font-size:24px'></i>{{ $prodImage->price}}</strong></span>
                                        <span class="h6 text-underline"><del>{{ $prodImage->cross_price}}</del></span>
                                    </div>
                                </div>                        
                            </div>                                               
                        </div> 
